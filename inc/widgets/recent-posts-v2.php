<?php
add_action('widgets_init', 'cs_recent_post_v2');

function cs_recent_post_v2() {
    register_widget('CS_Recent_Post_V2');
}

class CS_Recent_Post_V2 extends WP_Widget {

    function __construct() {
        parent::__construct(
                'cs_recent_post_v2', esc_html__('CMS Recent Post V.2','wp-experts'), array('description' => esc_html__('Recent Posts v.2 Widget', 'wp-experts'),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Recent Posts v.2', 'wp-experts' ) : $instance['title'], $instance, $this->id_base);
        ...
        echo '<aside id="cms-recent-post">';
            ...
            <?php if ($wp_query->have_posts()){ ?>
                <div class="cms-recent-post style-2">
