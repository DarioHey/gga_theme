...
<?php global $smof_data, $wp_experts_meta; 
    if(is_page() && !empty($wp_experts_meta->_cms_get_revslide))
        echo do_shortcode('[rev_slider_vc alias="'.$wp_experts_meta->_cms_get_revslide.'"]');
?>
<div id="cshero-header-inner" class="header-9 h-style-16 m-style">
