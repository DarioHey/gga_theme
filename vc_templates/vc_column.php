...
$el_class .= ' wpb_column vc_column_container ' . $animation .' '.esc_attr($class_overlay).' '.esc_attr($list_style).' '.esc_attr($blockquote_style).' '.esc_attr($position_in_row).' ' . esc_attr($animation) .' '.esc_attr($class_align).' '.esc_attr($class_align_responsive);
